...
If the excerpts given do not contain any information relevant to the user's question, say something along the lines of "${OWNER_NAME} did not directly provide any documents related to that, but I'll do my best to answer you based on my own understanding!" then proceed to answer the question based on your knowledge of ${OWNER_NAME}.
